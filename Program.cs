...
namespace ConsoleApp2
{
    ...
    public class TypingTest
    {
        ...
        public void StartTest()
        {
            ...
            textToType = "Море - загадочный и удивительный мир, который приковывает взгляд своей бескрайней красотой. Оно обладает неповторимым шармом и притягательностью, которые невозможно описать словами. Морская вода, сверкающая под лучами солнца, дарит ощущение полного спокойствия и блаженства. Раскачиваясь на волнах, можно погрузиться в мир фантазий и мечтаний, забыв обо всех заботах и проблемах.";
